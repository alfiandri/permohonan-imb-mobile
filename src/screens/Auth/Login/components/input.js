import React, {forwardRef, useImperativeHandle, useState, createRef, useRef} from 'react';
                ...
                <View
                    ...
                    <View style={[_.row, _.itemsCenter]}>
                        <TextInput
                            ...
                            autoCapitalize="none"
                            autoCorrect={false}
                            style={[_.flex, _.pv_1, _.mr_2, {fontSize: 13, color: COLORS.black, fontFamily: FONTS.primary.reguler}]}
                        />
                        {password && (
                            <TouchableOpacity onPress={() => setShow(!show)} style={[_.mh_2]}>
                                <Icon name={show ? 'eye' : 'eye-slash'} size={18} color={COLORS.blackDark200} />
                            </TouchableOpacity>
                        )}
                    </View>
                </View>
