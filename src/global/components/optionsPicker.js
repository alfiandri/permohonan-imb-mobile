    ...
    (
        ...
        return (
            <>
                ...
                <View style={[_.p_1, _.ph_2, _.bgColor('white'), {borderBottomColor: COLORS.primaryLight, borderBottomWidth: 1}, containerStyle]}>
                    <View style={[_.row, _.height(55), _.itemsCenter, style]}>
                        <Text style={[_.mr_2]}>{label}</Text>
                        <TouchableOpacity disabled={!editAble} onPress={() => modal?.current.show()} style={[_.flex, _.row]}>
                            <Text
                                color={!isEmpty(value?.[keyLabel]) ? (editAble ? 'black' : 'primary') : 'primary'}
                                align="right"
